...
export const allRoleRoutes=[
  {
    ...
    name:'用户管理页面',
    component: () => import(/* webpackChunkName: 'home' */'@/views/home/index'),
    meta: {title: '用户管理页面',role: ['超级管理员','user1'],flag: '1'},
    children: [
      {
        // 路由地址
        path: '/user',
  ...
  },
  {
    ...
    name: '权限管理页面',
    component: () => import(/* webpackChunkName: 'home' */'@/views/home/index'),
    meta: {title: '权限管理页面',role: ['超级管理员','user1'],flag: '2'},
    children: [
      {
        // 路由地址
        path: 'role',
  ...
  },
  {
    ...
    name: '课程管理页面',
    component:  () => import(/* webpackChunkName: 'home' */'@/views/home/index'),
    meta: {title: '课程管理页面',role: ['超级管理员','user1'],flag: '1'},
    children: [
      {
        // 路由地址
        path: 'course',
  ...
  },
  {
    ...
    name: '广告管理页面',
    component: () => import(/* webpackChunkName: 'home' */'@/views/home/index'),
    meta: {title: '广告管理页面',role: ['超级管理员','user1'],flag: '1'},
    children: [
      {
        // 路由地址
        path: 'advert',
