<template>
  <el-card>
    ...
    <el-dialog title="分配角色" :visible.sync="dialogFormVisible">
      <alloc-role :currentUserId="currentUserId"
      :selectedRoles="selectedRoles" :allRoles="allRoles" @cancel="dialogFormVisible=false" @success="dialogFormVisible=false"></alloc-role>
    </el-dialog>
  </el-card>
</template>
