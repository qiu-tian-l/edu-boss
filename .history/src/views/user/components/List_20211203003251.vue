<template>
  <el-card>
    ...
    <el-dialog title="分配角色" :visible.sync="dialogFormVisible">
      <alloc-role :current-userId="currentUserId"
      :selected-roles="selectedRoles" :all-roles="allRoles" @cancel="dialogFormVisible=false" @success="dialogFormVisible=false"></alloc-role>
    </el-dialog>
  </el-card>
</template>
