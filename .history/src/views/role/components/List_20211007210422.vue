<template>
  <div class="role-list">
    <el-card class="box-card">
      ...
      <!-- 添加角色的对话框结构 -->
      <el-dialog :title="this.isEdit? '编辑角色':'添加角色' " :visible.sync="dialogFormVisible" width="30%">
        <!-- 将添加与编辑功能单独封装到组件中 -->
        <create-or-edit :is-edit="isEdit" :role-id="roleId" @success="handleSuccess" @cancel="handleCancel"></create-or-edit>
      </el-dialog>
    </el-card>
  </div>
</template>
