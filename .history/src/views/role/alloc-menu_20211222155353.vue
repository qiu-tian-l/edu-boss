<template>
  <div class="alloc-menu">
    <el-card>
      <el-tree ref="menu-tree" :data="menus" :props="defaultProps" show-checkbox default-expand-all node-key=" " :default-checked-keys="checkedKeys"></el-tree>
  ...
  methods: {
    ...
    getCheckKeys (menus) {
      ...
      menus.forEach(menu => {
        ...
        console.log(this.checkedKeys.push(menu.id))
