...
export default {
  ...
  created () {
    console.log('created方法中-->', this.checkedKeys)
  ...
  methods: {
    ...
    async loadRoleMenus () {
      ...
      if (data.code === '000000') {
        console.log('获取已选中的')
        console.log('loadRoleMenus函数中00 ', this.checkedKeys)
        this.getCheckKeys(data.data)
        console.log('loadRoleMenus函数中10 ', this.checkedKeys)
        // this.checkedKeys = this.tmpArr
        console.log('loadRoleMenus函数中20 ', this.checkedKeys)
