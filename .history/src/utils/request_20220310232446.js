...
// 请求的通用配置（设置基础URL+添加token信息）
// 使用axios实例发送请求的两种方式：1. instance({url: '/posts', method: 'GET'})；2. instance.get('/posts')
// 返回的是一个promise对象，所以可以调用then/catch等方法
...
// 默认导出，使用default关键字将一个值声明为默认导出，每个模块只能有一个默认导出
// 等同于export {request as default}
